alter table public.rentals
  ...
  add column if not exists meetup_location text null,
  ...
  add column if not exists last_proposed_by uuid null,
  ...
  add column if not exists latest_proposal_message_id uuid null;
