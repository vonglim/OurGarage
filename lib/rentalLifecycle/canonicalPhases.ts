...
export const WIZARD_STEP_TO_CANONICAL: Record<RentalWizardStep, CanonicalRentalPhase> = {
  ...
  rental_agreement_intro: 'pickup_confirmed',
  transition_agreement_reviewed: 'pickup_confirmed',
  transition_disclosures_complete: 'pickup_confirmed',
  transition_hold_authorized: 'pickup_confirmed',
  transition_agreement_signed: 'pickup_confirmed',
  transition_rental_activated: 'active_rental',
  rental_agreement: 'pickup_confirmed',
  liability_disclosures: 'pickup_confirmed',
  security_hold_authorization: 'pickup_confirmed',
  digital_signature: 'pickup_confirmed',
  rental_activation: 'pickup_confirmed',
