/**
 * LEGACY — superseded by ListingWizard (`app/listing.tsx`, `@/components/listingFlow`).
 * Previous rent-out / Supabase `listings` insert form preserved for reference only; not reachable from UI.
 */
...
export default function RentOutScreenLegacy() {
